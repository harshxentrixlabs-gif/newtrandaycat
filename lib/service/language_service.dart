...
class LanguageService extends Translations {
  ...
  Future<void> loadLanguages() async {
    _localizedValues['en'] =
    Map<String, String>.from(jsonDecode(await rootBundle.loadString('lib/translation/en.json')));
    _localizedValues['hi'] =
    Map<String, String>.from(jsonDecode(await rootBundle.loadString('lib/translation/hi.json')));
    _localizedValues['gu'] =
    Map<String, String>.from(jsonDecode(await rootBundle.loadString('lib/translation/gu.json')));
  }
