...
class AppImage {
  ...
  static Widget asset(
    ...
    double? safeWidth = (width != null && width.isFinite) ? width : null;
    double? safeHeight = (height != null && height.isFinite) ? height : null;
      ...
      return Image.network(
        ...
        errorBuilder: errorWidget != null
          ...
          return Container(
            ...
            height: height,
            // child: const Icon(Icons.error),
            child: AppImage.network(randomGirlImageUrl(),errorWidget:  Container(
              color: Colors.grey.shade300,
              width: width,
              height: height,
              child: const Icon(Icons.error),
    ...
    return CachedNetworkImage(
      ...
      errorWidget: errorWidget != null
        ...
        return Container(
          ...
          height: height,
          // child: const Icon(Icons.error),
          child: AppImage.network(/*"https://static.toiimg.com/thumb/118027703/118027703.jpg?height=746&width=420&resizemode=76&imgsize=1379507"*/randomGirlImageUrl(),errorWidget:  Container(
            color: Colors.grey.shade300,
            width: width,
            height: height,
            child: const Icon(Icons.error),
  ...
  static String randomGirlImageUrl() {
    final timestamp = DateTime.now().millisecondsSinceEpoch;
    return "https://xsgames.co/randomusers/avatar.php?g=female&unique=$timestamp";
  }
